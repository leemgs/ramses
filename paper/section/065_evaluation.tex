...
normalized plots. The named-industrial-task accuracy and the parameter-sensitivity
sweep are likewise released as measured CSVs under \texttt{code/data/actual/}.
Model-load time and peak-VRAM reductions (Fig.~\ref{fig:rameses_consolidated}) and
the 72-hour arrival-trace QoS series are drawn from separate consolidated runs.
