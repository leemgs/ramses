...
requests are retained in the failure-rate denominator.  The consolidated
figures below report the headline aggregates; the complete per-task percentile
tables for all systems accompany the request-level logs in the supplementary
