...
populated without fabricating data. A GPU-required Colab notebook is included to collect this taxonomy on a public tiny model as a supplemental artifact smoke test; those measurements do not evaluate RAMSES or replace the target-system experiment.
